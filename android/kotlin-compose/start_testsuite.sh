...
-d '{"class": ["ie.equalit.ouinet_examples.android_compose.OuinetStressTest"], "clearPackageData": "true", "deviceLogs": "true", "devices": ["Samsung Galaxy S24-14.0"], "app": "ouinet-debug-latest", "testSuite": "ouinet-debug-androidTest-latest"}' \
